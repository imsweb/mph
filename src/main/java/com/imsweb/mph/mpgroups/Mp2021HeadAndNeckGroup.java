...
public class Mp2021HeadAndNeckGroup extends MphGroup {

    // Head and Neck Histology Coding Rules
    // C000-C148, C300-C339, C410, C411, C479
    // (Excludes lymphoma and leukemia M9590 – M9992 and Kaposi sarcoma M9140)
    public Mp2021HeadAndNeckGroup() {
        super(MphConstants.MP_2021_HEAD_AND_NECK_GROUP_ID, MphConstants.MP_2021_HEAD_AND_NECK_GROUP_NAME, "C000-C148, C300-C339, C410, C411, C479", null, null,
        ...
        MphRule rule = new MphRule(MphConstants.MP_2021_HEAD_AND_NECK_GROUP_ID, "M3") {
            @Override
        ...
        rule = new MpRulePrimarySite(MphConstants.MP_2021_HEAD_AND_NECK_GROUP_ID, "M4");
        rule.getNotes().add("Use this rule only for multiple tumors.");
        rule.getNotes().add("Timing is irrelevant.");
        rule.getNotes().add("Histology is irrelevant.");
        _rules.add(rule);
        ...
        rule = new MphRule(MphConstants.MP_2021_HEAD_AND_NECK_GROUP_ID, "M5") {
            @Override
            public TempRuleResult apply(MphInput i1, MphInput i2, MphComputeOptions options) {
                TempRuleResult result = new TempRuleResult();
        ...
        rule = new MpRuleFiveYearsApart(MphConstants.MP_2021_HEAD_AND_NECK_GROUP_ID, "M6");
        ...
        rule = new MphRule(MphConstants.MP_2021_HEAD_AND_NECK_GROUP_ID, "M7") {
            @Override
            public TempRuleResult apply(MphInput i1, MphInput i2, MphComputeOptions options) {
                TempRuleResult result = new TempRuleResult();
                ...
                map1 = MphConstants.HEAD_AND_NECK_2021_SUBTYPES_FOR_SITE.get(i1.getPrimarySite());
                map2 = MphConstants.HEAD_AND_NECK_2021_SUBTYPES_FOR_SITE.get(i2.getPrimarySite());
        ...
        rule = new MphRule(MphConstants.MP_2021_HEAD_AND_NECK_GROUP_ID, "M8") {
            @Override
            public TempRuleResult apply(MphInput i1, MphInput i2, MphComputeOptions options) {
                TempRuleResult result = new TempRuleResult();
                Map<String, String> map1 = MphConstants.HEAD_AND_NECK_2021_TABLE_FOR_SITE.get(i1.getPrimarySite());
        ...
        rule = new MpRuleInsituAfterInvasive(MphConstants.MP_2021_HEAD_AND_NECK_GROUP_ID, "M9");
        ...
        rule = new MpRuleInvasiveAfterInsituLessThan60Days(MphConstants.MP_2021_HEAD_AND_NECK_GROUP_ID, "M10");
        rule.getNotes().add("The rules are hierarchical. Only use this rule when none of the previous rules apply.");
        ...
        rule = new MpRuleInvasiveAfterInsituGreaterThan60Days(MphConstants.MP_2021_HEAD_AND_NECK_GROUP_ID, "M11");
        rule.getNotes().add("The rules are hierarchical. Only use this rule when none of the previous rules apply.");
        ...
        rule = new MphRule(MphConstants.MP_2021_HEAD_AND_NECK_GROUP_ID, "M12") {
            @Override
            public TempRuleResult apply(MphInput i1, MphInput i2, MphComputeOptions options) {
                TempRuleResult result = new TempRuleResult();
                Map<String, String> map1 = MphConstants.HEAD_AND_NECK_2021_TABLE_FOR_SITE.get(i1.getPrimarySite());
        ...
        rule = new MpRuleNoCriteriaSatisfied(MphConstants.MP_2021_HEAD_AND_NECK_GROUP_ID, "M13");
