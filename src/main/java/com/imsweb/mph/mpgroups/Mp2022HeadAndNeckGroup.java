...
public class Mp2022HeadAndNeckGroup extends MphGroup {

    // Head and Neck
    // C000-C148, C300-C339, C410, C411, C442, C479
    // (Excludes lymphoma and leukemia M9590 – M9992 and Kaposi sarcoma M9140)
    public Mp2022HeadAndNeckGroup() {
        super(MphConstants.MP_2022_HEAD_AND_NECK_GROUP_ID, MphConstants.MP_2022_HEAD_AND_NECK_GROUP_NAME, "C000-C148, C300-C339, C410, C411, C479", null, null,
        ...
        MphRule rule = new MphRule(MphConstants.MP_2022_HEAD_AND_NECK_GROUP_ID, "M3") {
            @Override
        ...
        rule = new MpRulePrimarySite(MphConstants.MP_2022_HEAD_AND_NECK_GROUP_ID, "M4");
        rule.getNotes().add("Use this rule only for multiple tumors.");
        rule.getNotes().add("Timing is irrelevant.");
        rule.getNotes().add("Histology is irrelevant.");
        _rules.add(rule);
        ...
        rule = new MphRule(MphConstants.MP_2022_HEAD_AND_NECK_GROUP_ID, "M5") {
            @Override
            public TempRuleResult apply(MphInput i1, MphInput i2) {
                TempRuleResult result = new TempRuleResult();
                if (GroupUtility.isPairedSites(i1.getPrimarySite(), i2.getPrimarySite(), MphConstants.HEAD_AND_NECK_2022_PAIRED_SITES)) {
        ...
        rule = new MpRuleFiveYearsApart(MphConstants.MP_2022_HEAD_AND_NECK_GROUP_ID, "M6");
        ...
        rule = new MphRule(MphConstants.MP_2022_HEAD_AND_NECK_GROUP_ID, "M7") {
            @Override
            public TempRuleResult apply(MphInput i1, MphInput i2) {
                TempRuleResult result = new TempRuleResult();
                //Check if the two tumors are in the tables first
                Map<String, String> map1 = MphConstants.HEAD_AND_NECK_2022_TABLE_FOR_SITE.get(i1.getPrimarySite());
                Map<String, String> map2 = MphConstants.HEAD_AND_NECK_2022_TABLE_FOR_SITE.get(i2.getPrimarySite());
                ...
                map1 = MphConstants.HEAD_AND_NECK_2022_SUBTYPES_FOR_SITE.get(i1.getPrimarySite());
                map2 = MphConstants.HEAD_AND_NECK_2022_SUBTYPES_FOR_SITE.get(i2.getPrimarySite());
        ...
        rule = new MphRule(MphConstants.MP_2022_HEAD_AND_NECK_GROUP_ID, "M8") {
            @Override
            public TempRuleResult apply(MphInput i1, MphInput i2) {
                TempRuleResult result = new TempRuleResult();
                Map<String, String> map1 = MphConstants.HEAD_AND_NECK_2022_TABLE_FOR_SITE.get(i1.getPrimarySite());
        ...
        rule = new MpRuleInsituAfterInvasive(MphConstants.MP_2022_HEAD_AND_NECK_GROUP_ID, "M9");
        ...
        rule = new MpRuleInvasiveAfterInsituLessThan60Days(MphConstants.MP_2022_HEAD_AND_NECK_GROUP_ID, "M10");
        rule.getNotes().add("The rules are hierarchical. Only use this rule when none of the previous rules apply.");
        ...
        rule = new MpRuleInvasiveAfterInsituGreaterThan60Days(MphConstants.MP_2022_HEAD_AND_NECK_GROUP_ID, "M11");
        rule.getNotes().add("The rules are hierarchical. Only use this rule when none of the previous rules apply.");
        ...
        rule = new MphRule(MphConstants.MP_2022_HEAD_AND_NECK_GROUP_ID, "M12") {
            @Override
            public TempRuleResult apply(MphInput i1, MphInput i2) {
                TempRuleResult result = new TempRuleResult();
                String h1 = i1.getHistology(), icd1 = h1 + "/" + i1.getBehavior(), h2 = i2.getHistology(), icd2 = h2 + "/" + i2.getBehavior();
        ...
        rule = new MpRuleNoCriteriaSatisfied(MphConstants.MP_2022_HEAD_AND_NECK_GROUP_ID, "M13");
    ...
    public boolean isApplicable(String primarySite, String histology, String behavior, int year) {
        if (super.isApplicable(primarySite, histology, behavior, year))
            return true;
        return year >= 2022 && ("C754".equals(primarySite) || "C755".equals(primarySite)) && Arrays.asList("8680", "8690", "8692", "8693").contains(histology) && "3".equals(behavior);
    }
}
