...
public class Mp2018UrinarySitesGroup extends MphGroup {
    ...
    Rule M5	Abstract a single primary when tumors are diagnosed in the bladder C67_ and one or both ureter(s) C669 AND tumors are noninvasive in situ /2 urothelial carcinoma (flat tumor) 8120/2.
    ...
    */
    ...
    public Mp2018UrinarySitesGroup() {
        ...
        // Rule M7	Abstract multiple primaries when separate/non-contiguous tumors are two or more different subtypes/variants in Column 3 of Table 2 in the Equivalent Terms and Definitions. Timing is irrelevant.
        rule = new MphRuleTwoOrMoreDifferentSubTypesInTable(MphConstants.MP_2018_URINARY_GROUP_ID, "M7", MphConstants.URINARY_2018_TABLE2_SUBTYPES, false);
        ...
        // Rule M8	Abstract multiple primaries when separate/non-contiguous tumors are on different rows in Table 2 in the Equivalent Terms and Definitions. Timing is irrelevant.
        rule = new MphRuleDifferentRowsInTable(MphConstants.MP_2018_URINARY_GROUP_ID, "M8", MphConstants.URINARY_2018_TABLE2_ROWS, false);
        ...
        // Rule M10	Abstract a single primary when separate/non-contiguous tumors are on the same row in Table 2 in the Equivalent Terms and Definitions.  Timing is irrelevant.
        rule = new MphRuleSameRowInTable(MphConstants.MP_2018_URINARY_GROUP_ID, "M10", MphConstants.URINARY_2018_TABLE2_ROWS, false);
        ...
        rule.getNotes().add("The tumors may:");
