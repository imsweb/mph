...
public class Mp2018UrinarySitesGroup extends MphGroup {
    ...
    public Mp2018UrinarySitesGroup() {
        ...
        rule.setReason("Synchronous, separate/non-contiguous tumors that are on the same row in Table 2 in the Equivalent Terms and Definitions are single primary.");
