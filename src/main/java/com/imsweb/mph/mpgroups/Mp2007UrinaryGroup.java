...
public class Mp2007UrinaryGroup extends MphGroup {
    ...
    public Mp2007UrinaryGroup() {
        ...
        MphRule rule = new MphRule(MphConstants.MP_2007_URINARY_GROUP_NAME, "M3") {
            @Override
        ...
        rule = new MphRule(MphConstants.MP_2007_URINARY_GROUP_NAME, "M4") {
            @Override
            public TempRuleResult apply(MphInput i1, MphInput i2) {
                TempRuleResult result = new TempRuleResult();
        ...
        rule = new MpRuleInvasiveAfterInsituGreaterThan60Days(MphConstants.MP_2007_URINARY_GROUP_NAME, "M5");
        ...
        rule = new MphRule(MphConstants.MP_2007_URINARY_GROUP_NAME, "M6") {
            @Override
            public TempRuleResult apply(MphInput i1, MphInput i2) {
                TempRuleResult result = new TempRuleResult();
        ...
        rule = new MphRule(MphConstants.MP_2007_URINARY_GROUP_NAME, "M8") {
            @Override
            public TempRuleResult apply(MphInput i1, MphInput i2) {
                TempRuleResult result = new TempRuleResult();
        ...
        rule = new MpRuleHistology(MphConstants.MP_2007_URINARY_GROUP_NAME, "M9");
        _rules.add(rule);
        ...
        rule = new MpRulePrimarySite(MphConstants.MP_2007_URINARY_GROUP_NAME, "M10");
        _rules.add(rule);

        // M11- Tumors that do not meet any of the criteria are abstracted as a single primary.
        rule = new MpRuleNoCriteriaSatisfied(MphConstants.MP_2007_URINARY_GROUP_NAME, "M11");
